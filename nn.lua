--[[ I plan for this neural network to accept a stft of a 1-channel audio
 recording and determine which of several words it is (aka give a probability),
 provided some training data of course. What this nn will NOT do
 is understand full sentences, we will get there later.
...
trainset = torch.load('all_ynm.t7')
